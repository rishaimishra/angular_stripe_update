...
@Component({
	selector: 'app-course-by-vendor',
	templateUrl: './course-by-vendor.component.html',
	styleUrls: ['./course-by-vendor.component.scss']
})
export class CourseByVendorComponent implements OnInit, OnChanges {
	@Input() data: any;
