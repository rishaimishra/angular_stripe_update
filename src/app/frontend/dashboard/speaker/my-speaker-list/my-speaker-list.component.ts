...
@Component({
  selector: 'app-my-speaker-list',
  templateUrl: './my-speaker-list.component.html',
  styleUrls: ['./my-speaker-list.component.scss']
})
export class MySpeakerListComponent implements OnInit {
  ...
  getNotificationRecords() {
    ...
    this.myRoute.navigate([`dashboard/my-speaker/edit/${speaker.id}`]);
  }
